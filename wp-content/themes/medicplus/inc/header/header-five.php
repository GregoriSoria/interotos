<header>
    <div class="header-topbar bg-gray border-top header-heart-center">
        <div class="container"><?php
            echo '<div class="topbar-left ticker-news">'.$topbar_left.'</div>';
            echo '<div class="topbar-right ticker-info"><ul class="list-inline list-unstyled topbar_right">'.$social;
     ...
     <div class="clearfix"></div>
    <div class="header-banner header-heart-center">
        <div class="container">
            <div class="header-banner-wrapper">
                ...
                echo '<div class="banner-header pull-right"><ul class="list-inline list-unstyled topbar_right">'.$topbar_right.'</ul></div>';?>
                <div class="clearfix"></div>
            </div>
        </div>
    </div>
