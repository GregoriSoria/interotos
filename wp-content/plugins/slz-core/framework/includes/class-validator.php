...
Medicplus_Core::load_class( 'DateTime_Parser' );

class Medicplus_Core_Validator {
	/**
	...
	public static $built_in_validators = array(
		'required' => 'Medicplus_Core_Validator_Required',
		'filter'   => 'Medicplus_Core_Validator_Filter',
		'match'    => 'Medicplus_Core_Validator_Regular_Expression',
		'email'    => 'Medicplus_Core_Validator_Email',
		'url'      => 'Medicplus_Core_Validator_Url',
		'compare'  => 'Medicplus_Core_Validator_Compare',
		'length'   => 'Medicplus_Core_Validator_String',
		'in'       => 'Medicplus_Core_Validator_Range',
		'numerical'=> 'Medicplus_Core_Validator_Number',
		'default'  => 'Medicplus_Core_Validator_Default_Value',
		'boolean'  => 'Medicplus_Core_Validator_Boolean',
		'date'     => 'Medicplus_Core_Validator_Date',
		'type'     => 'Medicplus_Core_Validator_Type'
	);
	...
	public static function create_validator( $name, $object, $attributes, $params = array() ) {
		...
		if( method_exists( $object, $name ) ) {
			$validator = new Medicplus_Core_Validator_Inline;
 ...
 * @since 1.0
 */ 
class Medicplus_Core_Validator_Date extends Medicplus_Core_Validator {
	/**
	...
	protected function validate_attribute( $object, $attribute ) {
		...
		foreach( $formats as $format ) {
			$timestamp = Medicplus_Core_DateTime_Parser::parse( $value, $format, array( 'month' => 1, 'day' => 1, 'hour' => 0, 'minute' => 0, 'second' => 0 ) );
			if( $timestamp !== false ) {
				$valid = true;
 ...
 * @since 1.0
 */
class Medicplus_Core_Validator_Type extends Medicplus_Core_Validator {
	/**
	...
	public function validate_value( $value ) {
		...
		if( $type === 'integer' ) {
			...
			return Medicplus_Core_DateTime_Parser::parse( $value, $this->date_format, array( 'month' => 1, 'day' => 1, 'hour' => 0, 'minute' => 0, 'second' => 0 ) ) !== false;
		} elseif( $type === 'time' ) {
			return Medicplus_Core_DateTime_Parser::parse( $value, $this->time_format ) !== false;
		} elseif( $type === 'datetime' ) {
			return Medicplus_Core_DateTime_Parser::parse( $value, $this->datetime_format, array( 'month' => 1, 'day' => 1, 'hour' => 0, 'minute' => 0, 'second' => 0 ) ) !== false;
		}
 ...
 * @since 1.0
 */ 
class Medicplus_Core_Validator_Inline extends Medicplus_Core_Validator {
	/**
 ...
 * @since 1.0
 */ 
class Medicplus_Core_Validator_Boolean extends Medicplus_Core_Validator {
	/**
 ...
 * @since 1.0
 */
class Medicplus_Core_Validator_Compare extends Medicplus_Core_Validator {
	/**
 ...
 * @since 1.0
 */
class Medicplus_Core_Validator_Email extends Medicplus_Core_Validator {
	/**
 ...
 * @since 1.0
 */
class Medicplus_Core_Validator_Default_Value extends Medicplus_Core_Validator {
	/**
 ...
 * @since 1.0
 */
class Medicplus_Core_Validator_Filter extends Medicplus_Core_Validator {
	/**
 ...
 * @since 1.0
 */
class Medicplus_Core_Validator_Number extends Medicplus_Core_Validator {
	/**
 ...
 * @since 1.0
 */
class Medicplus_Core_Validator_Range extends Medicplus_Core_Validator {
	/**
 ...
 * @since 1.0
 */
class Medicplus_Core_Validator_Regular_Expression extends Medicplus_Core_Validator {
	/**
 ...
 * @since 1.0
 */
class Medicplus_Core_Validator_Required extends Medicplus_Core_Validator {
	/**
 ...
 * @since 1.0
 */
class Medicplus_Core_Validator_String extends Medicplus_Core_Validator {
	/**
 ...
 * @since 1.0
 */
class Medicplus_Core_Validator_Url extends Medicplus_Core_Validator {
	/**
	 * @var string the regular expression used to validate the attribute value.
