...
Medicplus_Core::load_class( 'Validator' );

class Medicplus_Core_Model {
	...
	public function create_validators() {
		...
		foreach( $this->rules() as $rule ) {
			if( isset( $rule[0], $rule[1] ) ) {// attributes, validator name
				$validators[] = Medicplus_Core_Validator::create_validator( $rule[1], $this, $rule[0], array_slice( $rule, 2 ) );
			} else {
