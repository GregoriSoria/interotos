 ...
 * @since 1.0
 */
class Medicplus_Core_DateTime_Parser {
	/**
	...
	public static function parse( $value, $pattern = 'MM/dd/yyyy' , $defaults = array() ) {
		...
		if(Medicplus_Core_Timestamp::is_valid_date( $year, $month, $day ) && Medicplus_Core_Timestamp::is_valid_time( $hour, $minute, $second ) ) {
			return Medicplus_Core_Timestamp::get_timestamp( $hour, $minute, $second, $month, $day, $year );
		} else {
			return false;
		}
	}
 ...
 * @since 1.0
 */ 
class Medicplus_Core_Timestamp {
	/**
