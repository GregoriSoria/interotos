...
$redux_opt_name = SLZCORE_THEME_OPTIONS;
...
if ( ! function_exists( 'medicplus_core_register_custom_extension_loader' ) ) :
	function medicplus_core_register_custom_extension_loader( $ReduxFramework ) {
	...
	add_action( "redux/extensions/{$redux_opt_name}/before", 'medicplus_core_register_custom_extension_loader', 0 );
