...
vc_map(array(
	'name'        => esc_html__( 'SLZ Team Carousel', 'slz-core' ),
	'base'        => 'slzcore_team_carousel_sc',
	'class'       => 'slzcore-sc',
	'icon'        => 'icon-slzcore_team_carousel_sc',
	'category'    => SLZCORE_SC_CATEGORY,
	'description' => esc_html__( 'Carousel team a list.', 'slz-core' ),
	'params'      => $params
	)
);